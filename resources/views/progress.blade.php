          ...
          <tr>
            ...
            <td>
              ...
              @if ($task->nametask == $taskname[$i] && $task->id == $taskId[$i])
                ...
                <td>
                  <button type="button " name="button" class="btn btn-info" data-toggle="modal" data-target="#exampleModal">Check</button>
                </td>
                </tr>
                @else
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-danger">Repair</button>
